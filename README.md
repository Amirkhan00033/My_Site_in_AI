...
Современный сайт-портфолио с AI помощником. Темная тема, неоновые акценты, стеклянные карточки.

### Что внутри:
- 🤖 **Умный чат** - отвечает на вопросы про цены и сроки
- 🎨 **Красивый дизайн** - градиенты, свечение, анимация
- 📱 **Адаптация** - работает на телефонах и компьютерах
...
- Telegram: [@tvoy_login](https://t.me/tvoy_login)
- GitHub: [@tvoy_login](https://github.com/tvoy_login)